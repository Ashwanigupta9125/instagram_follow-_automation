...
import time
import insta_automation_to_follow as auto_insta
...
proxy_ip_port=['185.254.65.225:8800','185.201.245.137:8800','185.254.65.103:8800']
...
def open_brow(input_value_in_IP_range, user_id, user_password,):
    ...
    driver = webdriver.Firefox(executable_path="E:\work001\geckodriver-v0.29.1-win64\geckodriver.exe")
